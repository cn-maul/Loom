...
export default function TraitList({ traits, onVerified, eventLabels }: Props) {
  ...
  return (
    <div className="space-y-3">
      ...
      {traits.map((trait) => (
        <div
          key={trait.id}
          className="rounded-xl border border-border bg-card p-3 shadow-sm transition-opacity"
